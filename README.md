...
下载 [TokyoRepacker-v1.0.0-Beta-lite.zip](https://github.com/TokyoEric/apple-wz/releases/download/v1.0.0-Beta/TokyoRepacker-v1.0.0-Beta-lite.zip)，解压后需确保系统已安装 **JDK 21**。
...
| 自定义图标 | 有 | ✅ 256x256 嵌入 |
| 中文文档 | ❌ 无 | ✅ GUIDE + FEATURES + REPORT |

---

## 更新日志

- **Beta V1.0**（2026-07-07）— 首次发布。修复 MCP 缺陷、优化编译流程、加入自定义图标、全中文文档。
